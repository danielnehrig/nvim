...
function LSP:on_attach(client, bufnr)
    ...
    map(bufnr, "n", "<space>af", "<cmd>lua vim.lsp.buf.code_action()<CR>")
    map(bufnr, "n", "<space>ge", "<cmd>lua vim.lsp.util.show_line_diagnostics()<CR>")
    map(bufnr, "n", "<space>ar", "<cmd>lua vim.lsp.buf.rename()<CR>")
    ...
    map(bufnr, "n", "<space>cd", "<cmd>lua vim.lsp.diagnostic.show_line_diagnostics({border = 'single' })<CR>")
